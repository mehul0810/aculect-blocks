		...
		<div class="wrap aculect-blocks-admin">
			...
			<div class="aculect-blocks-admin__layout">
				<form class="aculect-blocks-admin__panel" action="<?php echo esc_url( admin_url( 'options.php' ) ); ?>" method="post">
					...
					<?php $this->render_toggle( 'patterns_enabled', __( 'Authoring patterns', 'aculect-blocks' ), __( 'Registers practical patterns for card grids, FAQ sections, and breadcrumb page headers.', 'aculect-blocks' ), $settings ); ?>
					<?php $this->render_toggle( 'faq_schema_enabled', __( 'Accordion FAQ schema', 'aculect-blocks' ), __( 'Adds machine-readable FAQPage schema from visible core Accordion content.', 'aculect-blocks' ), $settings ); ?>
					<?php $this->render_toggle( 'breadcrumb_schema_enabled', __( 'Breadcrumb schema', 'aculect-blocks' ), __( 'Adds BreadcrumbList schema from rendered core Breadcrumbs blocks while avoiding duplicate SEO graph output.', 'aculect-blocks' ), $settings ); ?>
				...
				<div class="aculect-blocks-admin__aside">
					<section class="aculect-blocks-admin__panel">
						...
						<ul class="aculect-blocks-admin__status-list">
							...
							<?php $this->render_status( __( 'Patterns', 'aculect-blocks' ), $settings['patterns_enabled'] ? __( 'Enabled', 'aculect-blocks' ) : __( 'Disabled', 'aculect-blocks' ), $settings['patterns_enabled'] ); ?>
