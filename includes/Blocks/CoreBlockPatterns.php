...
final class CoreBlockPatterns implements Module {
	...
	private function card_grid_pattern(): string {
		return '<!-- wp:columns {"className":"is-style-aculect-feature-grid"} -->'
			...
			. '<!-- wp:column --><div class="wp-block-column"><!-- wp:group {"className":"is-style-aculect-card","layout":{"type":"constrained"}} --><div class="wp-block-group is-style-aculect-card"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">' . esc_html__( 'Feature title', 'aculect-blocks' ) . '</h3><!-- /wp:heading --><!-- wp:paragraph --><p>' . esc_html__( 'Describe the outcome this card helps a visitor understand.', 'aculect-blocks' ) . '</p><!-- /wp:paragraph --><!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button {"className":"is-style-aculect-secondary"} --><div class="wp-block-button is-style-aculect-secondary"><a class="wp-block-button__link wp-element-button">' . esc_html__( 'Learn more', 'aculect-blocks' ) . '</a></div><!-- /wp:button --></div><!-- /wp:buttons --></div><!-- /wp:group --></div><!-- /wp:column -->'
			. '<!-- wp:column --><div class="wp-block-column"><!-- wp:group {"className":"is-style-aculect-card","layout":{"type":"constrained"}} --><div class="wp-block-group is-style-aculect-card"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">' . esc_html__( 'Feature title', 'aculect-blocks' ) . '</h3><!-- /wp:heading --><!-- wp:paragraph --><p>' . esc_html__( 'Keep the content short enough to scan during page building.', 'aculect-blocks' ) . '</p><!-- /wp:paragraph --><!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button {"className":"is-style-aculect-secondary"} --><div class="wp-block-button is-style-aculect-secondary"><a class="wp-block-button__link wp-element-button">' . esc_html__( 'Learn more', 'aculect-blocks' ) . '</a></div><!-- /wp:button --></div><!-- /wp:buttons --></div><!-- /wp:group --></div><!-- /wp:column -->'
			. '<!-- wp:column --><div class="wp-block-column"><!-- wp:group {"className":"is-style-aculect-card","layout":{"type":"constrained"}} --><div class="wp-block-group is-style-aculect-card"><!-- wp:heading {"level":3} --><h3 class="wp-block-heading">' . esc_html__( 'Feature title', 'aculect-blocks' ) . '</h3><!-- /wp:heading --><!-- wp:paragraph --><p>' . esc_html__( 'Use core block controls to tune spacing, colors, and typography.', 'aculect-blocks' ) . '</p><!-- /wp:paragraph --><!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button {"className":"is-style-aculect-secondary"} --><div class="wp-block-button is-style-aculect-secondary"><a class="wp-block-button__link wp-element-button">' . esc_html__( 'Learn more', 'aculect-blocks' ) . '</a></div><!-- /wp:button --></div><!-- /wp:buttons --></div><!-- /wp:group --></div><!-- /wp:column -->'
			. '</div><!-- /wp:columns -->';
	}
